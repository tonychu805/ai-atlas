...
export const PRODUCTS: Product[] = [
  ...
  { id: "amd-mi500", name: "AMD Instinct MI500 series", vendor: "AMD", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_gpu", family: "CDNA 6", status: "announced", node: "TSMC N2P", avail: "2027", attrs: { node_maturity: "leading_edge", transistor_arch: "gaa_nanosheet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "AMD confirmed at Advancing AI 2025. CDNA 6 architecture on TSMC N2P. HBM4E. AMD claims up to 1,000× MI300X-class AI performance (compound improvement across generations). Targeted 2027." }], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["synopsys", "cadence"], materials: ["shin-etsu", "unimicron", "ibiden", "shinko"], equipment: ["tokyo-electron", "applied-materials", "lam-research", "asml", "kla"], packaging_osat: ["ase", "amkor"], test: ["ase", "amkor"] }, rels: [], sources: [] },
  ...
  { id: "nvidia-feynman", name: "NVIDIA Feynman GPU", vendor: "NVIDIA", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_gpu", family: "Feynman", status: "announced", node: "TSMC A16 (1.6nm-class)", avail: "2028", attrs: { node_maturity: "leading_edge", transistor_arch: "gaa_nanosheet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "Successor to Rubin Ultra; 3D stacking, custom next-gen HBM; pairs with Rosa CPU" }], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["synopsys", "cadence"], materials: ["shin-etsu", "kinsus", "unimicron", "ibiden"], equipment: ["tokyo-electron", "applied-materials", "lam-research", "asml", "kla"], packaging_osat: ["ase", "tsmc"], test: ["ase", "tsmc"] }, rels: [], sources: [] },
  { id: "nvidia-feynman-ultra", name: "NVIDIA Feynman Ultra (rumored)", vendor: "NVIDIA", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_gpu", family: "Feynman", status: "announced", node: "TSMC A16 (1.6nm-class)", avail: "2029-2030", attrs: { node_maturity: "leading_edge", transistor_arch: "gaa_nanosheet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "Unconfirmed enhanced variant analogous to the Blackwell Ultra / Rubin Ultra pattern" }], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["synopsys", "cadence"], materials: ["shin-etsu", "kinsus", "unimicron", "ibiden"], equipment: ["tokyo-electron", "applied-materials", "lam-research", "asml", "kla"], packaging_osat: ["ase", "tsmc"], test: ["ase", "tsmc"] }, rels: [], sources: [] },
  ...
  { id: "google-tpu-v1", name: "Google TPU v1", vendor: "Google", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "eol", node: "TSMC 28nm", avail: "2016", attrs: { node_maturity: "mature", transistor_arch: "planar", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "TSMC 28nm. Inference-only, internal (not cloud-accessible). Broadcom co-developed as ASIC partner from inception." }], bom: null, supply: { foundry_fab: ["tsmc"] }, rels: [], sources: [] },
  { id: "google-tpu-v2", name: "Google TPU v2", vendor: "Google", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "eol", node: "TSMC 16nm", avail: "2017", attrs: { node_maturity: "advanced", transistor_arch: "finfet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "TSMC 16nm (some sources cite 20nm). Google-designed; Broadcom co-develops and coordinates TSMC production." }], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["broadcom"] }, rels: [], sources: [] },
  { id: "google-tpu-v3", name: "Google TPU v3", vendor: "Google", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "eol", node: "TSMC 12nm", avail: "2018", attrs: { node_maturity: "advanced", transistor_arch: "finfet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [], bom: null, supply: { foundry_fab: ["tsmc"] }, rels: [], sources: [] },
  { id: "google-tpu-v4", name: "Google TPU v4", vendor: "Google", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "production", node: "TSMC 7nm", avail: "2021", attrs: { node_maturity: "leading_edge", transistor_arch: "finfet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [], bom: null, supply: { foundry_fab: ["tsmc"] }, rels: [], sources: [] },
  ...
  { id: "google-tpu-v5p", name: "Google TPU v5p", vendor: "Google", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "production", node: "TSMC", avail: "2023", attrs: { material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["synopsys", "cadence"], materials: ["shin-etsu", "air-liquide", "sumco"], equipment: ["tokyo-electron", "applied-materials", "asml", "kla"], packaging_osat: ["ase", "tsmc"], test: ["ase", "tsmc"] }, rels: [], sources: [] },
  {
    ...
    family: 'Trillium', status: 'production', node: 'TSMC 4nm (enhanced)', avail: '2024', verified: '2026-03',
    attrs: { node_maturity: 'leading_edge', transistor_arch: 'finfet', material_system: 'si', integration_level: 'package', end_market: 'datacenter' },
    specs: [
  ...
  { id: "google-tpu-v7", name: "Google TPU v7 (Ironwood / TPU7x)", vendor: "Google", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "production", node: "TSMC N3P", avail: "2025-2026", attrs: { node_maturity: "leading_edge", transistor_arch: "finfet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "TSMC N3P. 192GB HBM3e, 700mm² die, 4,614 FP8 TFLOPS. Broadcom co-develops training-focused cores; MediaTek handles I/O design and TSMC packaging coordination. First TPU offered to external customers (Anthropic up to 1M chips)." }], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["synopsys", "cadence", "broadcom"], materials: ["shin-etsu", "air-liquide", "sumco"], equipment: ["tokyo-electron", "applied-materials", "lam-research", "asml", "kla"], packaging_osat: ["ase", "tsmc"], test: ["ase", "tsmc"] }, rels: [], sources: [] },
  { id: "google-tpu-v8", name: "Google TPU 8 (8t train / 8i infer)", vendor: "Google", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "announced", node: "TSMC N2", avail: "2026 (late)", attrs: { node_maturity: "leading_edge", transistor_arch: "gaa_nanosheet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "TSMC N2. First split-purpose TPU pair: 8t (training) and 8i (inference) are separate chips. 288GB HBM on 8i. Citadel Securities named launch customer." }], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["synopsys", "cadence"], materials: ["shin-etsu", "air-liquide", "sumco"], equipment: ["tokyo-electron", "applied-materials", "lam-research", "asml", "kla"], packaging_osat: ["ase", "tsmc"], test: ["ase", "tsmc"] }, rels: [], sources: [] },
  ...
  { id: "aws-trainium", name: "AWS Trainium", vendor: "AWS", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "eol", avail: "2022", attrs: { material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [], bom: null, supply: {}, rels: [], sources: [] },
  {
    ...
    specs: [
      ...
      { label: 'Notes',          value: 'Powers Project Rainier (Anthropic), ~500k chips' },
    ],
  ...
  { id: "tenstorrent-wormhole", name: "Tenstorrent Wormhole", vendor: "Tenstorrent", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "production", node: "TSMC 7nm", avail: "2023", attrs: { node_maturity: "leading_edge", transistor_arch: "finfet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "TSMC 7nm. 80 Tensix cores, 12×100G Ethernet scale-out. GDDR6 memory." }], bom: null, supply: { foundry_fab: ["tsmc"] }, rels: [], sources: [] },
  { id: "tenstorrent-blackhole", name: "Tenstorrent Blackhole", vendor: "Tenstorrent", domain: "logic", sub: "ai_accelerator", subcat: "ai_accelerator_asic", status: "production", node: "TSMC N6", avail: "2024-2025", attrs: { node_maturity: "leading_edge", transistor_arch: "finfet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "TSMC N6 (6nm). 140 Tensix cores, 16 big RISC-V cores, 12×400G Ethernet. GDDR6. Next-gen Quasar/Grendel chiplets on Samsung SF4X (4nm)." }], bom: null, supply: { foundry_fab: ["tsmc"] }, rels: [], sources: [] },
  ...
  { id: "google-axion", name: "Google Axion", vendor: "Google", domain: "logic", sub: "cpu", subcat: "cpu_server", family: "Arm Neoverse N4A / V2", status: "production", node: "TSMC 3nm", avail: "2024-2025", attrs: { node_maturity: "leading_edge", transistor_arch: "finfet", material_system: "si", integration_level: "package", end_market: "datacenter" }, specs: [{ label: "Notes", value: "TSMC 3nm. Arm Neoverse V2-based. Design support from GUC (Global Unichip, TSMC affiliate). Available as C4A and N4A VM types in Google Cloud." }], bom: null, supply: { foundry_fab: ["tsmc"], design_ip_eda: ["synopsys", "cadence", "arm"], materials: ["shin-etsu", "air-liquide", "sumco"], equipment: ["tokyo-electron", "applied-materials", "asml", "kla"], packaging_osat: ["ase", "tsmc"], test: ["ase", "tsmc"] }, rels: [], sources: [] },
